...
<html lang="cs">
    ...
    <body class="dark">
        ...
        <div class="container">
            ...
            <main>
                    <h2 class="contact-box scroll-end">Kontaktní údaje</h2>
...
?>
    ...
    <form  action="(domain)/mailer.php" method="post">
                    <div>
                    ...
                    <div>
                        <label for="message"><i class="fa-solid fa-pen"></i> Tvůj vzkaz</label>
